...
1. Open RStudio, ensure the environment is clear, and restart R.

1. Create a new quarto document and save it as ads-week6-joins.qmd

1. In a new code chunk, load the tidyverse.
