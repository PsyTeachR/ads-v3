...
If you run this code interactively in the source pane, you won't see the sparklines. You have to render to be able to see them because they rely on some javascript code that is created by `sparkline(0)` in the setup chunk. 
