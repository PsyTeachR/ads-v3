...
* ::: closes the first column and the next ::: opens the second one.
...
* At the very end, you’ll see two more :::, the first closes the second column and the second closes the grid layout.
