...
::: {.callout-note}
Learn more about accessibility in @sec-accessibility.
:::
...
``` markdown
![ADS](images/logos/logo.png){width="200px" fig-alt="A rainbow-bordered hexagon with the words 'Applied Data Skills"}
```
