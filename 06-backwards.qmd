...
-   To get started, download this <a href="https://psyteachr.github.io/ads-v3/data/backwards_report.zip" download>zip file</a> which contains the data files and the finished html report that you need to backwards engineer from the data. 
...
- You have no other work to do this week for ADS - this replaces the workshops, reading, quizzes, and AITutoR so expect to spend quite a few hours on the report. It won't be something you're likely to do in one sitting. 
...
The mark for participation and attendance component rewards consisrent engagement with the course. Programming is not a skill that can

Whilst most of the skills required for this report have been explicitly taught, there are minor bits of the coding that will require you to look up solutions independently. This will be good practice for the final report and for applying your coding skills to your own work.
